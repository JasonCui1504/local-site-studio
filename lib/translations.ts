...
const en = {
  ...
  dashboard: {
    title: "Dashboard",
    sub: "Welcome back — here's how your site is doing.",
    ...
    healthItems: {
      ...
      menu: "Menu up to date",
      hours: "Hours confirmed",
      photos: "Photos recently updated",
      contact: "Contact info verified",
    },
    ...
    stats: {
      ...
      allPagesUp: "All pages up",
    },
  },

  requests: {
    title: "Change Requests",
    sub: "Submit a request and we'll take care of it — usually within 24 hours.",
